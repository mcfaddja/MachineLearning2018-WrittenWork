...
Using Haar cascades improves the performance, as it removes a lot of bias from the dataset. The accuracy curves of a few of the experiments are given in \textbf{Figure } and 

\begin{figure}
\includegraphics[width=3.5in]{Picture1}
\caption{Accuracy and Error curves for the final experiment with the CNN model (\emph{created from scratch}).}
\end{figure}
